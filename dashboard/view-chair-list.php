					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Kursi</span></li>
								<li><span>List Kursi</span></li>
							</ol>
					...
					<!-- start: page -->
						...
						<section class="panel">
							...
							<header class="panel-heading">
								...
								<h2 class="panel-title">Semua Kursi</h2>
							</header>
							<div class="panel-body">
							<a href="#exampleModal" class="btn btn-success"  data-toggle="modal" >Tambah Kursi</a>
								<table class="table table-bordered table-striped mb-none" id="datatable-tabletools" data-swf-path="assets/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf">
									...
									<tbody>
										...
										$sql = "SELECT * FROM `kursi` WHERE tbl_id = '$tbl_id' ;";
		  ...
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      <div class="modal-header">
		        <h5 class="modal-title" id="exampleModalLabel">Tambah Kursi</h5>
		      ...
		      <div class="modal-footer">
		        ...
		        <input type="submit" name="addchair" class="btn btn-primary" value="Tambah Kursi">
		      </div>
		  	  </form>
		    </div>
		  </div>
...
<?php 
	if (isset($_POST['addchair'])) {
		...
		$indert = false;
		$tbl_name = "";
		$sql = "SELECT * FROM `meja` WHERE id = '$tbl_id' ;";
		$result = $con->query($sql);
		foreach ($result as $r) {
		...
		for ($i=1; $i <= $num_of_chair ; $i++) { 
			$chair_no = $i;
			$exct = "-";
			$iquery="INSERT INTO `kursi`( `tbl_id`, `chair_no`) 
