...
<body>
	<section class="body">
			...
			<section role="main" class="content-body">
				...
				<section class="panel">
					<header class="panel-heading">
						...
						<h2 class="panel-title">Semua Menu</h2>
					</header>
					<div class="panel-body">
						<a href="menu-add.php"><button class="btn btn-success">Tambah Menu</button></a><br><br>
        ...
        caranya membedakannya, gunakan id_barang sebagai pembeda data-target di setiap modal -->
											...
											<a href="menu-edit.php?id=<?php echo $r['id']; ?>"><button class="btn btn-warning">Edit</button></a>
