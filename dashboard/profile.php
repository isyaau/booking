      ...
      <div class="inner-wrapper">
        ...
        <section role="main" class="content-body">
          ...
          <section>
                ...
                // SELECT `id`, `nama`, `email`, `phone`, `address`, `location`, `logo`, `password`, `bkashnumber`, `approve_status`, `role` FROM `user` WHERE 1
                ...
                if (isset($_POST['save'])) {
                  # code...
                  $sql = "UPDATE `user` SET `nama`='".$_POST['fullname']."',`email`='".$_POST['email']."',`phone`='".$_POST['phone']."',`address`='".$_POST['address']."',`location`='".$_POST['area']."',`password`='".$_POST['password']."' WHERE `id`='$res_id'";
                  $cur = $con->query($sql);
                  if ($cur) {
                    # code...
            ...
            // get the file name
                    ...
                    if ($extension =="jpg" || $extension =="png" || $extension =="jpeg"){
                      move_uploaded_file($file_tmp,$targetDirectory.$file_name);
                        $sql = "UPDATE `user` SET `logo`='".$file_name."' WHERE `id`='$res_id'"; 
      ...
      <div class="row">    
              ...
              <div class="form-group">
                ...
                <label class="col-md-4 control-label" for=
                  ...
                  <div class="col-md-8">
                   <input type="text" name="fullname" class="form-control" required="" placeholder="Nama Cafe" value="<?php echo $row['nama'];?>">
                  </div>
                </div>
              </div> 
