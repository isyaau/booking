						...
						<div class="panel-body">
							<div class="invoice">
								<header class="clearfix">
									<div class="row">
										...
										<?php 
											...
											$con = connect();
											$res_id = $_SESSION['id'];
											$sql = "SELECT * FROM `user` where id = '$res_id';";
											$result = $con->query($sql);
											foreach ($result as $r) {
										?>
										<div class="col-sm-8 text-right mt-md mb-md">
											<address class="ib mr-xlg">
												<b class="text-capitalize"><?php echo $r['nama']; ?></b>
												<br/>
												<?php echo $r['address']; ?>
												<br/>
								...
								<?php 
									...
									$sql2 = "SELECT * FROM `reservasi` where booking_id = '$booking_number';";
								...
								<div class="bill-info">
									<div class="row">
										<div class="col-md-6">
											<div class="bill-to">
												<p class="h5 mb-xs text-dark text-semibold">Dari:</p>
												<address>
													<?php echo $booking_name; ?>
													<br/>
													No Hp: +62 <?php echo $booking_phone; ?>
										...
										<div class="col-md-6">
											<div class="bill-data text-right">
												<p class="mb-none">
													<span class="text-dark">Tanggal Booking:</span>
													<span class="value"><?php echo $booking_date; ?></span>
												</p>
												<p class="mb-none">
													<span class="text-dark">Waktu Booking:</span>
								...
								<div class="bill-info">
									<div class="row">
										<div class="col-md-6">
											<div class="bill-to">
												<p class="h5 mb-xs text-dark text-semibold">Meja dan Kursi:</p>
												<address>
													<?php 
													$booking_number = $_GET['booking-number'];
													$sql3 = "SELECT bc.booking_id,bc.chair_no,rt.table_name
														FROM kursi_booking as bc, kursi as rc,meja as rt
												...
												<p class="h5 mb-xs text-dark text-semibold">Layout</p>
												<img style="width: 200px;height: auto;" src="user-image/<?php echo $layout; ?>" alt="<?php echo $booking_time; ?>" />
											</div>
										</div>
									</div>
								</div>
									...
									<table class="table invoice-items">
										<thead>
											<tr class="h4 text-dark">
												...
												<th id="cell-item"   class="text-semibold">Nama Item</th>
												<th id="cell-price"  class="text-left text-semibold">Tanggal</th>
										...
										<tbody>
											...
											$sql4 = "SELECT bm.booking_id,bm.qty,mi.item_name,mi.price
												FROM booking_menus as bm, menu as mi
											...
											<tr>
												...
												<td>Rp.<?php echo $r4['price']; ?></td>
												<td class="text-center"><?php echo $r4['qty']; ?></td>
												<td class="text-center">Rp.<?php echo $subtotal= $r4['price'] * $r4['qty']; ?> 
												</td>
											</tr>
											<?php $count++; } ?>
										</tbody>
											...
											<table class="table h5 text-dark">
												<tbody>
													<tr class="h4">
														...
														<td class="text-left">Rp.<?php echo $grand_total; ?></td>
													</tr>
												</tbody>
											</table>
										</div>
