  ...
  <body style="background-image:url('images/squares.png')">
   ...
   <?php include 'template/nav-bar.php'; ?>
    ...
    <section class="home-slider owl-carousel" style="height: 400px;">
      <div class="slider-item" style="background-image: url('images/view3.jpeg');" data-stellar-background-ratio="0.5">
        <div class="overlay"></div>
        <div class="container">
          <div class="row slider-text align-items-center justify-content-center">
            <div class="col-md-10 col-sm-12 ftco-animate text-center" style="padding-bottom: 25%;">
              <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home</a></span> <span>Meja</span></p>
              <h1 class="mb-3">Pilih Meja</h1>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-5">
          <div class="col-md-7 text-center heading-section ftco-animate">
            <span class="subheading text-white">Meja</span>
            <h2 class="text-white">Pilih Meja Anda</h2>
          </div>
        </div>
                ...
                <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                  <div class="row">
                      ...
                      <?php
                        include 'dbCon.php';
                        $con = connect();
                        $sql = "SELECT * FROM `meja` WHERE res_id = '$res_id';";
                      ...
                      <div class="col-lg-3" style="min-height: 190px">
                        ...
                        <nav class="menu2">
                          ...
                          <ul>
                            <?php
                              $sql2 = "SELECT * FROM `kursi` WHERE tbl_id = '$table_id';";
                              ...
                              foreach ($result2 as $r2) {
                                ...
                                $cbbook = "SELECT bc.id,bc.booking_id,bc.chair_id,bc.chair_no,bd.booking_id,bd.res_id,bd.booking_date,bd.booking_time
                                  FROM kursi_booking as bc, reservasi as bd
