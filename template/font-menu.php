      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-5">
          <div class="col-md-7 text-center heading-section ftco-animate">
            <span class="subheading">Paling Disukai</span>
        ...
        <div class="row">
          <div class="col-md-12 dish-menu">
            ...
            <div class="nav nav-pills justify-content-center ftco-animate" id="v-pills-tab" role="tablist" aria-orientation="vertical">
              ...
              <a class="nav-link py-3 px-4" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false"><span class="flaticon-cheers"></span> Minuman</a>
              <a class="nav-link py-3 px-4" id="v-pills-messages-tab" data-toggle="pill" href="#v-pills-messages" role="tab" aria-controls="v-pills-messages" aria-selected="false"> Tempat</a>
            </div>
            ...
            <div class="tab-content py-5" id="v-pills-tabContent">
              <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                <div class="row">
                  <div class="col-lg-6">
                       <?php 
                      $sql2 = "SELECT * FROM `menu` WHERE food_type = 'Fast Food' LIMIT 5";
                  ...
                  <div class="col-lg-6">
                    <?php 
                      $sql2 = "SELECT * FROM `menu` WHERE food_type = 'Fast Food' LIMIT 5 , 5";
                      $result2 = $con->query($sql2);
                      foreach ($result2 as $r2) {
                    ?>
                    <div class="menus d-flex ftco-animate">
     ...
     <!--                <div class="menus d-flex ftco-animate">
              ...
              <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                <div class="row">
                  <div class="col-lg-6">
                    ...
                    <?php 
                      $sql2 = "SELECT * FROM `menu` WHERE food_type = 'Drink' LIMIT 5";
                      $result2 = $con->query($sql2);
                      foreach ($result2 as $r2) {
                    ?>
                    <div class="menus d-flex ftco-animate">
                  ...
                  <div class="col-lg-6">
                  <?php 
                      $sql2 = "SELECT * FROM `menu` WHERE food_type = 'Drink' LIMIT 5 , 5";
                      $result2 = $con->query($sql2);
                      foreach ($result2 as $r2) {
                    ?>
                    <div class="menus d-flex ftco-animate">
              ...
              <div class="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                <div class="row">
                  <div class="col-lg-6">
                            <?php 
                      $sql2 = "SELECT * FROM `menu` WHERE food_type = 'Tempat' LIMIT 5";
                      $result2 = $con->query($sql2);
                      foreach ($result2 as $r2) {
                    ?>
                    <div class="menus d-flex ftco-animate">
                      ...
                      <div class="text d-flex">
                        ...
                        <div class="one-forth">
                          <span class="price"> <small><?php echo $r2['price']; ?></small></span><br> 
                        </div> 
                      </div>
                    </div>
                    <?php } ?>
<!--                     <div class="menus d-flex ftco-animate">
                  ...
                  <div class="col-lg-6">
                            <?php 
                      $sql2 = "SELECT * FROM `menu` WHERE food_type = 'Dessert' LIMIT 5 , 5";
                      $result2 = $con->query($sql2);
                      foreach ($result2 as $r2) {
                    ?>
                    <div class="menus d-flex ftco-animate">
