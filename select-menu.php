...
<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.8.3/jquery.min.js"></script>
  <body>
    ...
    <section class="home-slider owl-carousel" style="height: 400px;">
      <div class="slider-item" style="background-image: url('images/view1.jpeg');" data-stellar-background-ratio="0.5">
        <div class="overlay"></div>
        <div class="container">
          <div class="row slider-text align-items-center justify-content-center">
            <div class="col-md-10 col-sm-12 ftco-animate text-center"  style="padding-bottom: 25%;">
              <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home</a></span> <span>Menu</span></p>
              <h1 class="mb-3">Pilih Menu dan untuk Acara Apa</h1>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-5">
          <div class="col-md-7 text-center heading-section ftco-animate">
            <span class="subheading">Semua Menu dan Tempat untuk Acara</span>
            <h2>Pilih Makanan, Minuman, dan untuk Acara Apa</h2>
          </div>
        </div>
        <div class="row">
        <div class="col-md-8 dish-menu">
            ...
            <div class="nav nav-pills justify-content-center ftco-animate" id="v-pills-tab" role="tablist" aria-orientation="vertical">
              ...
              <a class="nav-link py-3 px-4" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false"> Tempat dan Alat</a>
            ...
            <div class="tab-content py-5" id="v-pills-tabContent">
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <?php 
                      include 'dbCon.php';
                      $con = connect();
                      $sql = "SELECT * FROM `menu` WHERE res_id = '$res_id' AND food_type = 'Fast Food';";
              ...
              <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                <div class="row">
                  <div class="col-lg-12">
                    <?php 
                      $sql2 = "SELECT * FROM `menu` WHERE res_id = '$res_id' AND food_type = 'Tempat';";
            ...
            <div class="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                <div class="row">
                  <div class="col-lg-12">
                    <?php 
                      $sql3 = "SELECT * FROM `menu` WHERE res_id = '$res_id' AND food_type = 'Drink';";
